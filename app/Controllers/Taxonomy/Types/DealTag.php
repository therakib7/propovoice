...
class DealTag { 
    ...
    public function create_taxonomy() {
        ...
        if ( !is_blog_installed() || taxonomy_exists( 'ncpi_deal_tag' ) ) {
            return;
        }
         
        do_action('ncpi_deal_tag_taxonomy');  
        ...
        register_taxonomy( 'ncpi_deal_tag', array( 'ncpi_deal' ), apply_filters('ncpi_deal_tag_taxonomy_args', $args) ); 
