...
class I18n
{
    static function dashboard()
    {
        return [
            ...
            'markpaid' => esc_html__('Mark As Paid', 'propovoice'),  
            'markcom' => esc_html__('Mark as completed', 'propovoice'),  
            ...
            'transection' => esc_html__('Transection', 'propovoice'),  
            ...
            'clolor' => esc_html__('clolor', 'propovoice'),  
            ...
            'firs' => esc_html__('Firs', 'propovoice'),  
