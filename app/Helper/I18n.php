...
class I18n
{
    static function dashboard()
    {
        return [
            ...
            //invoice
            'dill' => esc_html_x('Bill To', 'Client View', 'propovoice'),
            'payinfo' => esc_html_x('Payment Info', 'Client View', 'propovoice'),
            'no' => esc_html_x('No', 'Client View', 'propovoice'),
            //table
            ...
            'foundQuery' => esc_html__('No %s found by your search query.', 'propovoice'),  
