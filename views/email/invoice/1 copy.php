...
<html xmlns="https://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body class="ncpi_body" style="margin:0px; padding:0px;" bgcolor="#efefef">
        <table class="ncpi_full_wrap" valign="top" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#efefef" align="center">
            <tbody>
            <tr>
                <td valign="top" align="center">
                    <table class="ncpi_main_table" style="width:800px;" width="800" cellspacing="0" cellpadding="0" border="0" align="center">
                        <!--Header section-->
                        <tbody>
                        <tr>
                            <td style="padding:15px;" class="ncpi_padd" valign="top" bgcolor="#f6f7f8" align="center">
                        ...
                        <tr>
                            <td valign="top" align="center">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                    <tbody>
                                    <tr>
                                        <td valign="top" align="center"><img class="ncpi_img" alt="merry Christmas" style="display:block; font-family:Arial, sans-serif; font-size:30px; line-height:34px; color:#000000; max-width:700px;" src="images/05be8b57-6b90-4ebd-ba17-4014c79f2e4b.jpg" width="700" border="0" height="345"></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td style="padding:35px 70px 30px;" class="ncpi_padd" valign="top" bgcolor="#0d1121" align="center">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                    <td class="ncpi_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                        ...
                        <!--Footer Section-->
                        <tr>
                            <td style="padding:38px 30px;" class="ncpi_padd" valign="top" bgcolor="#f6f7f8" align="center">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tbody>
                                    <tr>
                        ...
                        <tr>
                            <td class="ncpi_hide" style="line-height:1px;min-width:700px;background-color:#ffffff;"><img alt="" src="images/spacer.gif" style="max-height:1px; min-height:1px; display:block; width:700px; min-width:700px;" width="700" border="0" height="1"></td>
                        </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <div class="ncpi_hide" style="white-space: nowrap; display: none; font-size:0px; line-height:0px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
    </body>
</html>