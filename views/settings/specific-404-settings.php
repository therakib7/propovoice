...
/**
 * Specific 404 Settings.
 */ 
$options = [
	'head_section' => [
		'title'       => esc_html__('404 Page', 'propovoice'),
		'type'        => 'title',
	],  
	'status' => [
...
if ( Functions::is_enable('css') ) {
	$options['css'] = [
		...
		'description'     => wp_kses( 
			__('- This CSS will load in 404 page</br>- You don\'t need &lt;style>&lt;/style> tag here', 'propovoice'), 
			['br' => [] ]
		),
	];
}
...
if ( Functions::is_enable('js') ) {
	$options['js'] = [
		...
		'description'     => wp_kses( 
			__('- This JS will load in 404 page</br>- You don\'t need &lt;script>&lt;/script> tag here', 'propovoice'), 
			['br' => [] ]
		),
	];
...
if ( Functions::is_enable('html') ) {
	$options['html'] = [
		...
		'description'     => wp_kses( 
			__('This HTML will load in 404 page', 'propovoice'), 
			['br' => [] ]
		),
	];
...
return apply_filters('ncpi_specific_404_settings_options', $options);
