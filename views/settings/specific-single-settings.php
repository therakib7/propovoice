...
/**
 * Specific Single Settings.
 */ 
$options = [
	'head_section' => [
		'title'       => esc_html__('Single Page', 'propovoice'),
		'type'        => 'title',
	],  
	'status' => [
...
if ( Functions::is_enable('css') ) {
	$options['css'] = [
		...
		'description'     => wp_kses( 
			__('- This CSS will load in single page</br>- You don\'t need &lt;style>&lt;/style> tag here', 'propovoice'), 
			['br' => [] ]
		),
	];
}
...
if ( Functions::is_enable('js') ) {
	$options['js'] = [
		...
		'description'     => wp_kses( 
			__('- This JS will load in single page</br>- You don\'t need &lt;script>&lt;/script> tag here', 'propovoice'), 
			['br' => [] ]
		),
	];
...
if ( Functions::is_enable('html') ) {
	$options['html'] = [
		...
		'description'     => wp_kses( 
			__('This HTML will load in single page', 'propovoice'), 
			['br' => [] ]
		),
	];
...
return apply_filters('ncpi_specific_single_settings_options', $options);
