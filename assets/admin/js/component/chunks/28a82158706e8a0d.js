...
/* harmony import */ var api_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! api/client */ "./src/admin/js/react/api/client.js");
...
var Client = /*#__PURE__*/function (_Component) {
  ...
  function Client(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getLists", function () {
      ...
      api_client__WEBPACK_IMPORTED_MODULE_5__["default"].getAll(params).then(function (resp) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSubmit", function (client) {
      if (_this.state.formModalType == 'new') {
        api_client__WEBPACK_IMPORTED_MODULE_5__["default"].create(client).then(function (resp) {
        ...
        api_client__WEBPACK_IMPORTED_MODULE_5__["default"].update(client.id, client).then(function (resp) {
          if (resp.data.success) {
            _this.setState({
              formModal: false
    ...
    _defineProperty(_assertThisInitialized(_this), "deleteEntry", function (type, index) {
      if (confirm(_this.context.CrudMsg.confirm)) {
        ...
        api_client__WEBPACK_IMPORTED_MODULE_5__["default"].remove(ids).then(function (resp) {
          if (resp.data.success) {
...
_defineProperty(Client, "contextType", context_app_context__WEBPACK_IMPORTED_MODULE_2__["default"]);
