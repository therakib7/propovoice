...
var Invoice = (_temp = _class = /*#__PURE__*/function (_Component) {
  ...
  function Invoice(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSubmit", function (invoice) {
      if (_this.state.formModalType == 'new') {
        _api_invoice__WEBPACK_IMPORTED_MODULE_5__["default"].create(invoice).then(function (resp) {
          if (resp.data.success) {
            _this.setState({
              formModal: false
            });
        ...
        _api_invoice__WEBPACK_IMPORTED_MODULE_5__["default"].update(invoice.id, invoice).then(function (resp) {
          if (resp.data.success) {
            _this.setState({
              formModal: false
            }); // this.setState({ formModalType: 'new' });
