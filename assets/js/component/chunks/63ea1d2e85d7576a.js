...
var _onDragEnd = function onDragEnd(update, result, columns, setColumns) {
  ...
  if (source.droppableId !== destination.droppableId) {
    ...
    var sourceItems = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(sourceColumn.items);

    var destItems = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(destColumn.items);

    var _sourceItems$splice = sourceItems.splice(source.index, 1),
        _sourceItems$splice2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_sourceItems$splice, 1),
        removed = _sourceItems$splice2[0];

    destItems.splice(destination.index, 0, removed);
    setColumns(_objectSpread(_objectSpread({}, columns), {}, (_objectSpread2 = {}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_objectSpread2, source.droppableId, _objectSpread(_objectSpread({}, sourceColumn), {}, {
      items: sourceItems
    })), (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_objectSpread2, destination.droppableId, _objectSpread(_objectSpread({}, destColumn), {}, {
      items: destItems
    })), _objectSpread2))); //update another stage

    var deal_id = parseInt(columns[source.droppableId].items[source.index].id);
    var deal_stage_id = parseInt(destColumn.id);
    var finalArray = destItems.map(function (obj) {
      return parseInt(obj.id);
    });
    update('deals', deal_id, {
      stage_id: deal_stage_id,
      reorder: finalArray
    }); //update come from api hoc
  } else {
    var column = columns[source.droppableId];

    var copiedItems = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(column.items);

    var _copiedItems$splice = copiedItems.splice(source.index, 1),
        _copiedItems$splice2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_copiedItems$splice, 1),
        _removed = _copiedItems$splice2[0];

    copiedItems.splice(destination.index, 0, _removed);
    setColumns(_objectSpread(_objectSpread({}, columns), {}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, source.droppableId, _objectSpread(_objectSpread({}, column), {}, {
      items: copiedItems
    })))); //update deal in same stage

    var _finalArray = copiedItems.map(function (obj) {
      return parseInt(obj.id);
    });

    var _deal_id = parseInt(columns[source.droppableId].items[source.index].id);

    update('deals', _deal_id, {
      reorder: _finalArray
    });
  }
};
...
function Pipeline(props) {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(1590),
  ...
  var goToSingle = function goToSingle(id) {
    navigate("/deal/single/".concat(id));
  };

  var CharLimit = function CharLimit(string) {
    var limit = 28;

    if (string.length > limit) {
      return "".concat(string.substring(0, limit), "... ");
    }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
    ...
    ,
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_7__.DragDropContext, {
      onDragEnd: function onDragEnd(result) {
        return _onDragEnd(props.update, result, columns, setColumns);
      },
      children: Object.entries(columns).map(function (_ref, index) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          className: "pi-board-column",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            className: "pi-board-column-title pi-bg-shadow",
            style: {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("h4", {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("button", {
                className: columnId == dropdown ? 'pi-active' : '',
                onClick: function onClick() {
                  return showDropdown(columnId);
                },
              ...
              }), columnId == dropdown && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
                className: "pi-dropdown-content pi-show" // ref={popover}
                ,
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("a", {
                  onClick: function onClick() {
                    props.taxForm('edit', column);
                    showDropdown(columnId);
                  },
                  children: "Edit"
                })
              })]
            ...
            children: function children(provided, snapshot) {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", _objectSpread(_objectSpread({}, provided.droppableProps), {}, {
                ...
                children: [column.items.map(function (item, index) {
                  var img = ndpi.assetImgUri + 'avatar.png';
                  ...
                  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_7__.Draggable, {
                    ...
                    children: function children(provided, snapshot) {
                      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", _objectSpread(_objectSpread(_objectSpread({
                        ...
                        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
                          className: "pi-board-item-top",
                          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("h4", {
                            children: CharLimit(item.title)
                          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("span", {
                            children: ["$ ", item.budget]
                          }), !wage.length && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("p", {
                            children: ["Probability: ", item.probability, "%"]
                          })]
                        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
                          ...
                          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("img", {
                            ...
                            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("h5", {
                              children: [item.person ? item.person.first_name : item.org.name, " "]
                            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("p", {
                              children: [item.person ? item.person.region : item.org.region, item.person ? item.person.country : item.org.country]
                            }), column.type == 'won' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
                              className: "pi-badge",
                              style: {
                              ...
                              children: "Won"
                            }), column.type == 'lost' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
                              className: "pi-badge",
                              style: {
                ...
                }), provided.placeholder, index == 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("button", {
                  className: "pi-btn pi-btn-medium pi-bg-stroke pi-bg-shadow pi-bg-hover-shadow",
                  onClick: function onClick() {
                    return props["new"]('new');
                  },
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("svg", {
                    width: 14,
                    height: 12,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,hoc_Api__WEBPACK_IMPORTED_MODULE_4__["default"])(Pipeline));
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Form, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
        ...
        }),  false && /*#__PURE__*/0, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
          className: "pi-total-list",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("p", {
            children: [i18n.show, " ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("select", {
              onChange: showItem,
            ...
            }), title, " ", this.props.boardView ? 'Per Stage' : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
              children: ["from ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("span", {
                children: total
              })]
            })]
          })
...
/* harmony import */ var block_pro_alert__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! block/pro-alert */ "./src/js/blocks/pro-alert/index.js");
/* harmony import */ var hoc_Crud__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! hoc/Crud */ "./src/js/hoc/Crud.js");
...
var Deal = function Deal(props) {
  ...
  var taxForm = function taxForm() {
    ...
    if (type == 'new' && wage.length > 0) {
      (0,block_pro_alert__WEBPACK_IMPORTED_MODULE_12__["default"])();
      return;
    }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
    ...
    children: [!props.module_id && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(block_breadcrumb__WEBPACK_IMPORTED_MODULE_3__["default"], {
      title: title + ' Pipeline'
    }), props.state.formModal && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_Form__WEBPACK_IMPORTED_MODULE_8__["default"], {
      handleSubmit: props.handleSubmit,
      modalType: props.state.formModalType,
      data: props.state.list,
      close: props.closeForm
    }), modal && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(block_field_taxonomy_Form__WEBPACK_IMPORTED_MODULE_6__["default"], _objectSpread(_objectSpread({}, props), {}, {
      taxonomy: "deal_stage",
      title: "Stage",
    ...
    }), !wage.length && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_Search__WEBPACK_IMPORTED_MODULE_10__["default"], {
      title: title,
      ...
      boardView: boardView
    }), checkedBoxes.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(block_action_table__WEBPACK_IMPORTED_MODULE_7__["default"], {
      length: checkedBoxes.length,
      uncheckAll: props.uncheckAll,
      deleteEntry: props.deleteEntry
    }), props.state.empty && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(block_empty__WEBPACK_IMPORTED_MODULE_11__["default"], {
      title: title,
      searchVal: searchVal,
      clickHandler: function clickHandler() {
        return props.openForm('new');
      }
    }), props.state.preloader || loading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(block_preloader_table__WEBPACK_IMPORTED_MODULE_4__["default"], {}) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.Fragment, {
      children: [!props.module_id && boardView && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_Pipeline__WEBPACK_IMPORTED_MODULE_5__["default"], {
        "new": props.openForm,
        data: lists,
        taxForm: taxForm
      }), (props.module_id || !boardView) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_Table__WEBPACK_IMPORTED_MODULE_9__["default"], {
          tableData: lists,
          searchVal: searchVal,
          ...
          deleteEntry: props.deleteEntry
        }), props.state.totalPage > 1 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(Pagination, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,hoc_Crud__WEBPACK_IMPORTED_MODULE_13__["default"])(Deal, 'deal', ndpi.i18n.deal));
