...
export default (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (mForm.due_date) {
            let startDate = moment(mForm.due_date).format('YYYY-MM-DD');
            mForm.due_date = startDate;
        }
            ...
            <div className="pv-tab-buttons-group">
                ...
                <div className="pv-tab-buttons">
                    <div className="pv-action-content">
                        <DateField date={form.due_date} label={i18n.due_date} type='due_date' place='task' onDateChange={onDateChange} />
                    </div>
