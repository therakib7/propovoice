    ...
    return (
      <tr key={index}>
        ...
        <td
          ...
          className="pv-cursor-pointer"
        >
          {row.budget && row.currency ? currency(row.budget, row.currency) : ""}
        </td>
        <td>
          {row.status_id && (
            <>
              {row.status_id.color && row.status_id.bg_color && (
                <span
                  className="pv-badge"
                  style={{
              ...
              {(!row.status_id.color || !row.status_id.bg_color) && (
                <span className="pv-badge">{row.status_id.label}</span>
              )}
            </>
          )}
        </td>
