...
export default (props) => {
    const [templates, setTemplates] = useState([
        { 
           id: 1,
           src: "https://i.imgur.com/hVetkjH.jpg",
        },
        { 
           id: 2,
           src: "https://i.imgur.com/9VBRMK4.jpg",
        },
        { 
           id: 3,
           src: "https://i.imgur.com/O9h6AJc.jpg",
        },
        { 
           id: 4,
           src: "https://i.imgur.com/bHNRyId.jpg",
        }
    ]);  
                    ...
                    return (
                        <div className="col-12 col-md-6 col-lg-3" key={index}>
                            <div className='pv-single-image-content'>
                                <img src={row.src} className={'pv-single-image ' + (props.currentTemplate == row.id ? 'pv-active' : '')} />
