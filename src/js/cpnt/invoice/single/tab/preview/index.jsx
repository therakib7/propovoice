...
const EditDownload = (props) => {
  ...
  if (
    props.inv &&
    props.inv.hasOwnProperty("status") &&
    (props.inv.status == "paid" || props.inv.status == "accept")
  ) {
    return <></>;
  }
...
export default class Preview extends Component {
  ...
  componentDidMount() {
    ...
    api
      .get("settings", "tab=email_" + this.props.path + "_default")
      .then((resp) => {
        ...
        <div className="row justify-content-md-center" style={{ overflow: 'hidden' }}>
          ...
          <div className="col-md-8">
            ...
            <div
              ...
              ref={this.previewRef}
            >
              {this.props.data.fromData && (
                <InvTemplate {...this.props} isPrvwLoad={this.isPrvwLoad} />
              )}
            </div>
