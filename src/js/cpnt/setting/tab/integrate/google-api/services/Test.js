...
const Test = () => {
 ...
 const handleChange = (e) => {
  ...
  const handleSubmit = e => {
    ...
    const clientId = target.client_id.value;
    const client_secret = target.client_secret.value;
    const redirect_uri = target.redirect_uri.value;
    const data = [clientId, client_secret, redirect_uri]
