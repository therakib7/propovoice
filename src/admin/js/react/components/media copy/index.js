    ...
    render() {
        ...
        return (
            <div className="ncpi-components">
                ...
                {this.state.preloader ? <TablePreloader /> : <Table tableData={medias} editEntry={this.openForm} checkedBoxes={{ data: checkedBoxes, handle: this.handleCheckbox }} deleteEntry={this.deleteEntry} />}
