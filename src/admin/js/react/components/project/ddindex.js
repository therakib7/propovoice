...
export default class Lead extends Component {
    ...
    getLists = (searchArgs = null) => {
        ...
        Api.getAll(params)
            .then(resp => {
                ...
                this.setState({ projects: result, preloader: false, empty, total, totalPage: Math.ceil(total / this.state.perPage) }); 
            })
    };
    ...
    render() {
        const { title, projects, checkedBoxes, searchVal } = this.state;
        ...
        return (
            <div className="ncpi-components">  
                ...
                {projects.length > 0 && <div className='pi-table-showing'>
                    <p>
                        {projects.length} {title} showing from {this.state.total}
                ...
                {this.state.preloader ? <Preloader /> : <Table tableData={projects} searchVal={searchVal} editEntry={this.openForm} checkedBoxes={{ data: checkedBoxes, handle: this.handleCheckbox }} deleteEntry={this.deleteEntry} />}
