                ...
                <div className="pi-payment-tab">
                    ...
                    <div className="pi-tab-content">
                        ...
                        <div id="pi-bank" data-tab-content="" className="active">
                            ...
                            {this.state.empty && <div className="pi-payment-empty-content pi-text-center">
                                <div>
                                    <span>
                                        ...
                                        >
                                            <path
                                                d="M12.348.556a2.737 2.737 0 013.306 0l11.578 8.78c1.475 1.118.684 3.451-1.169 3.46H1.937C.087 12.787-.707 10.454.77 9.336L12.348.556zM14 8.746c.464 0 .91-.184 1.237-.51a1.73 1.73 0 000-2.454 1.757 1.757 0 00-2.475 0 1.73 1.73 0 000 2.455c.329.325.774.508 1.238.508zM3.5 15.11v6.945H7V15.11H3.5zm5.833 0v6.945h3.5V15.11h-3.5zm5.833 0v6.945h3.5V15.11h-3.5zm5.834 0v6.945h3.5V15.11H21zM0 27.264c0-1.597 1.307-2.894 2.917-2.894h22.166c1.61 0 2.917 1.297 2.917 2.894v.579c0 .307-.123.6-.342.818a1.171 1.171 0 01-.825.339H1.167c-.31 0-.607-.122-.825-.339A1.153 1.153 0 010 27.843v-.58z"
                                                fill="#4A5568"
                                            />
                                        </svg>
                                        No Bank <br />
                            ...
                            {this.state.preloader ? <TablePreloader /> : <Table tableData={payments} editEntry={this.openForm} deleteEntry={this.deleteEntry} />}
