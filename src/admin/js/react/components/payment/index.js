...
export default class Payment extends Component {
    ...
    render() {
        ...
        return (
            <div className="ncpi-components">
                ...
                <div className="pi-pament-tab">
  <ul className="pi-tabs">
    <li data-tab-target="#pi-paypal" className="active pi-tab">
      <svg
        width={24}
        height={24}
        viewBox="0 0 23 27"
    ...
    <li data-tab-target="#pi-bank" className="pi-tab">
      <svg
        width={25}
        height={25}
        viewBox="0 0 28 29"
  ...
  <div className="pi-tab-content">
    <div id="pi-paypal" data-tab-content="" className="active">
      <img src="assets/img/pament-image.png" alt="pament-image" />
    ...
    <div id="pi-stripe" data-tab-content="">
      <div className="pi-title-content">
      ...
      <div className="pi-form-content pi-form-style-two">
        <div className="row">
          <div className="col-md">
            ...
            <select name="country">
              <option value="volvo">Italy</option>
        ...
        <div className="row">
          <div className="col-md">
            <label htmlFor="company">Routing Number</label>
            <input type="number" id="company" name="company" />
          </div>
          <div className="col-md">
            <label htmlFor="website">Branch</label>
        ...
        <div className="row">
          ...
          <div className="col-md">
            <label htmlFor="curency">Confirm Account Number</label>
    ...
    <div id="pi-bank" data-tab-content="">
      <ul>
