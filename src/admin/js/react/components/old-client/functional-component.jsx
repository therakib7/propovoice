                        ...
                        { clients && clients.map((client, index) => ( 
                            <tr key={index}>
                                ...
                                <td className="text-left py-3 px-4">
                                    ...
                                    <span onClick={() => openForm('edit', client)} className='bg-gray-800 hover:bg-gray-900 cursor-pointer text-white text-sm py-1 px-2 rounded mr-2'>Edit</span>
                                    <span className='bg-red-800 hover:bg-red-900 cursor-pointer text-white text-sm py-1 px-2 rounded'>Delete</span> 
                                </td>
                            </tr> 
                        )) } 
                    </tbody>
