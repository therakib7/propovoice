            ...
            <li>
                ...
                <div className="pi-payment-accrodion">
                    ...
                    <div className="pi-tab">
                        ...
                        <label className="pi-tab-label" htmlFor="pi-payment-paypal">
                            Paypal
                        </label>
                                ...
                                return (
                                    <div className="pi-payment-bank-content" key={index} onClick={() => this.setPayment(row)} >
                                        ...
                                        <div className="bank-text-content">
                                            ...
                                            <h4 className="pi-bank-title">Client ID: 654654</h4>
                                            <p className="pi-bank-subtitle">Secrect ID: 654654</p>
                                        </div>
                                    </div>
                                );
                            })}
                    ...
                    <div className="pi-tab">
                        <input type="radio" id="pi-payment-stripe" name="pi-payment-type" />
                        <label className="pi-tab-label" htmlFor="pi-payment-stripe">
                            Stripe
                        </label>
                        <div className="pi-tab-content">
                            {this.state.payments.map((row, index) => {
                                ...
                                return (
                                    <div className="pi-payment-bank-content" key={index} onClick={() => this.setPayment(row)} >
                                        ...
                                        <div className="bank-text-content">
                                            ...
                                            <h4 className="pi-bank-title">Public Key: 654654</h4>
                                            <p className="pi-bank-subtitle">Private Key: 654654</p>
                                        </div>
                                    </div>
                                );
                            })}
