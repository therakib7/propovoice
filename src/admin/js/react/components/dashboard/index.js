                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="pi-feedback-content pi-request pi-bg-blue">
                                ...
                                >
                                    <path
                                        d="M22.1396 50C1.83993 31.698 13.6814 -12.2109 22.1396 -31.8776L-14 -68V168H160.547C165.416 165.19 172.234 154.514 160.547 134.286C145.937 109 113.258 148.735 93.2654 119.235C73.2733 89.7347 46.3608 142.714 44.823 106.592C43.2851 70.4694 47.5142 72.8775 22.1396 50Z"
                                        fill="#C1CDFF"
                                        fillOpacity="0.37"
                                    />
                                </svg>
