                        ...
                        <ul>
                            ...
                            <li>
                                <a href="lead.html">
                                    ...
                                    >
                                        <path
                                            d="M10 7.072a3.398 3.398 0 100-6.797 3.398 3.398 0 000 6.797z"
                                            fill="#718096"
                                        />
                                        <path
                                            d="M16.875 7.072a2.148 2.148 0 100-4.297 2.148 2.148 0 000 4.297zM3.125 7.072a2.148 2.148 0 100-4.297 2.148 2.148 0 000 4.297zM5.242 9c-.846-.692-1.612-.6-2.59-.6A2.647 2.647 0 000 11.036v4.266c0 .631.515 1.145 1.149 1.145 2.735 0 2.406.05 2.406-.118 0-3.023-.358-5.24 1.687-7.328z"
                                            fill="#CBD5E0"
                                        />
                                        <path
                                            d="M10.93 8.415c-1.708-.142-3.192.002-4.473 1.059-2.143 1.716-1.73 4.027-1.73 6.854a1.37 1.37 0 001.368 1.369c8.245 0 8.573.265 9.062-.817.16-.366.117-.25.117-3.753 0-2.782-2.41-4.712-4.344-4.712z"
                                            fill="#718096"
                                        />
                                        <path
                                            d="M17.348 8.4c-.983 0-1.745-.091-2.59.6 2.03 2.073 1.687 4.139 1.687 7.329 0 .168-.273.117 2.365.117.657 0 1.19-.531 1.19-1.185v-4.225A2.647 2.647 0 0017.348 8.4z"
                                            fill="#CBD5E0"
                                        />
                                    </svg>
                                    Lead
                            ...
                            <li>
                                <a href="project.html">
                                    <img src="assets/img/project.png" alt="project" className="pi-mt-4" />
                                    Project
                                </a>
                            </li>
                            <li>
                    ...
                    <div className="pi-top-menu-content">
                        <div className="pi-width-content">
                            <div className="row">
                                ...
                                <div className="col">
                                    <div className="pi-avater pi-ml-45">
