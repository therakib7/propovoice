                            ...
                            <div className="relative w-auto my-6 mx-auto max-w-3xl">
                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                    ...
                                    <div className="flex items-start justify-between p-3 border-b border-solid border-blueGray-200 rounded-t">
                                        ...
                                        <button className="p-1 ml-auto bg-transparent border-0 text-black float-right text-3xl dealing-none font-semibold outline-none focus:outline-none"
                                            ...
                                            <div className="w-full max-w-lg">
                                                ...
                                                <div className="flex flex-wrap -mx-3 mb-2">
                                                    ...
                                                    <div className="w-full md:w-1/2 px-3">
                                                        ...
                                                        <input
                                                            className="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-2 px-4 dealing-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                            id="grid-email"
                                                            type="email"
                                                            required
                                                            name="email"
