            ...
            <div className="ncpi-components">
                ...
                <div className='mb-3 text-sm'>
                    <NavLink
                        to='/deal'
                        >
                        <span className="dashicons dashicons-arrow-left-alt2"></span> Back to Deal
                    </NavLink>
                </div>
                ...
                { currentTab == 'project' && <Project deal_id={id} /> }
                { currentTab == 'estimate' && <Estimate deal_id={id} /> }
                { currentTab == 'invoice' && <Invoice deal_id={id} /> }
