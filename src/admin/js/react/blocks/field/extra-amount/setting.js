										...
										{(provided, snapshot) => (
											...
											>
												...
												<div className="">
													...
													<span className="pi-title-small" style={{fontSize: '14px', paddingLeft: '20px'}}>Name: {item.label}</span>

													<span className="pi-title-small" style={{fontSize: '14px', paddingLeft: '20px'}}>Type: Tax</span>
													<span className="pi-title-small" style={{fontSize: '14px', paddingLeft: '20px'}}>Rate Type: Percent</span> 
